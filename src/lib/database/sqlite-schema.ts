// SPRINT-140F: schema inlined as a TS string so both the tsx (source) and
// esbuild (bundled dist) runtimes have it available without needing to
// ship the .sql file alongside every entry point. The .sql file is still
// the canonical source of truth for humans and diffs; keep them in sync.
